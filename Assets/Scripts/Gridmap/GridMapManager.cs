...
{
    /// <summary>
    /// Grid system for keeping track of grid operations
    /// </summary>
    public class GridMapManager : MonoBehaviour
    {
        ...
        /// <summary>
        /// Sets given grids(with starting point and dimension) Weights to max Value , and Occupation to ID. Also colors it blue.
        /// </summary>
        /// <param name="id"></param>
        ...
        public void OccupyGrids(string id, Vector2Int startingPoint, Vector2Int dimensions)
        {
            ...
            if (isSpaceOccupied(startingPoint, dimensions)) // Checks if the grid is already occupied before occupying it.
            {
                ResetGridHighlights();
                return;
            }
        ...
        /// <summary>
        /// Sets given grids(with starting point and dimension) Weights to min Value , and Occupation to "". Also colors it white.
        /// </summary>
        /// <param name="id"></param>
        /// <param name="startingPoint"></param>
        /// <param name="dimensions"></param>
        ...
        /// <summary>
        /// Get All Grids between starting and end grid.
        /// </summary>
        ...
        /// <summary>
        /// This function checks every cell for a grid thats occupation is "" , starting from the grid you have given
        /// </summary>
        ...
        /// <summary>
        /// Finds a Vector2Int List Of Route on the gridmap Using Weighted A* Pathfind Algorithm
        /// </summary>
        ...
        public List<Vector2Int> FindRouteAStar(Vector2Int start, Vector2Int end)
        {
            ...
            {
                //If we cant find a suitable end position , return closest suitable position.
            ...
            while (pool.Count > 0)
            {
                ...
                visited.Add(bestCell);
                pool.Remove(bestCell);
                //Best cell is now visited , check its neighboors named as candidates.
                var candidates = new List<Vector2Int> {
                    new Vector2Int(bestCell.x + 1, bestCell.y),
                    new Vector2Int(bestCell.x - 1, bestCell.y),
                    new Vector2Int(bestCell.x, bestCell.y + 1),
                ...
                //On this loop check if candidates are suitable for searching and add them to the pool.
                foreach (var candidate in candidates)
                {
            ...
            //After it finds a route ,add every cell to a newly created Route list
            if (!parents.ContainsKey(end))
                return null;
